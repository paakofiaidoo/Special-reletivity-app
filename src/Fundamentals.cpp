...
float Fundamentals::gamma(){
    ...
    cout << "input gamma : ";
    cin >>gammatemp;
    gammatemp = pow (gammatemp,2);
    gammatemp = 1/gammatemp;
    gammatemp = 1-gammatemp;
    gammatemp = sqrt(gammatemp);
    gammatemp = c()*gammatemp;
    cout << "velocity is therefore = "<<gammatemp<<endl;
    beta(gammatemp);
    return gammatemp;
}
...
float Fundamentals::massFunc(){
    ...
    if(option == '1'){
        ...
        cout << "input your mass in MeV/c^2 : ";
        cin >> mass;
        mass = mass * 1.79e-30;
    }else{
...
float Fundamentals::energyConv(double value, string from, string to){
    if(from == "J"){
        ...
        {
            cout << "value of " << value;
            cout << " from J to J is " << value <<" J"<< endl;
            return value;
        }else if (to == "eV")
        {
            cout << "value of " << value;
            value = value / 1.6022e-19;
            cout << " from J to eV is " << value <<" eV"<< endl;
            return value;
        }else if(to == "MeV")
        {
            cout << "value of " << value;
            value = value / (1.6022e-19 * 1e6);
            cout << " from J to MeV is " << value <<" MeV"<< endl;
            return value;
        }else
        {
        ...
        if (to == "J")
        {
            cout << "value of " << value;
            value = value * 1.6022e-19;
            cout << " from eV to J is " << value <<" J"<< endl;
            return value;
        }else if (to == "eV")
        {
            cout << "value of " << value;
            cout << " from eV to eV is " << value <<" eV"<< endl;
            return value;
        }else if(to == "MeV")
        {
            cout << "value of " << value;
            value = value  * 1e-6;
            cout << " from eV to MeV is " << value <<" MeV"<< endl;
            return value;
        }else
        {
            cout << "i don't know what i am converting to"<<endl;
        ...
        if (to == "J")
        {
            cout << "value of " << value;
            value = value * 1.6022e-19 *1e6;
            cout << " from MeV to J is " << value <<" J"<< endl;
            return value;
        }else if (to == "eV")
        {
            cout << "value of " << value;
            value = value *1e6;
            cout << " from MeV to eV is " << value <<" eV"<< endl;
            return value;
        }else if(to == "MeV")
        {
            cout << "value of " << value;
            cout << " from MeV to MeV is " << value <<" MeV"<< endl;
            return value;
        }else
        {
            cout << "i don't know what i am converting to"<<endl;
